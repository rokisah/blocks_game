...
class Content {
  ...
  Content(this.game, this.content, this._parent) {
    ...
    this._rect = Rect.fromLTWH((this._parent.x + 5) * game.tileSize, 0,
            game.tileSize, game.tileSize).deflate(5);
  ...
  Content.create(this.game, this.content, double x) {
    this.sprite = BlockUtil.getContentSprite(content);
    this._rect =
        Rect.fromLTWH((x + 1) * game.tileSize, game.tileSize, game.tileSize, game.tileSize)
            .deflate(5);
  }
